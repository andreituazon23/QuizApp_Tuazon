...
const quizData = [
    { question: 'Who painted the Mona Lisa', options: ['Jose Tuazon', 'Da Vinci', 'Leonardo San Miguel', 'Juan Luna'], correctAnswer: 'Da Vinci' },
    { question: 'What is 3 - 3?', options: ['0', '6', '12', '9'], correctAnswer: '9' },
